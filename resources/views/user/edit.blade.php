<x-crud-layout>
    <form method="POST" action="{{ route('user.store') }}">
        ...
        <div>
            ...
            <x-text-input id="nama_user" class="block mt-1 w-full" type="text" name="nama_user" :value="old('nama_user', $users->nama_user)" required autocomplete="nama_user" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="email" class="block mt-1 w-full" type="email" name="email" :value="old('email', $users->email)" required autocomplete="username" />
