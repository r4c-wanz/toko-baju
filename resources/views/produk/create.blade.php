<x-crud-layout>
    <form method="POST" action="{{ route('produk.store') }}">
        ...
        <div class="mt-4">
            ...
            <x-text-input id="merk_produk" class="block mt-1 w-full" type="text" name="merk_produk" :value="old('merk_produk')" required autocomplete="username" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="harga_produk" class="block mt-1 w-full" type="number" name="harga_produk" :value="old('harga_produk')" required autocomplete="username" />
